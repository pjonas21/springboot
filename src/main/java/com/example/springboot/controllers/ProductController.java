...
public class ProductController {
    ...
    public ResponseEntity<List<ProductModel>> getAllProducts() {
        List<ProductModel> productsList = productsServices.findAll();
    ...
    public ResponseEntity<Object> getOneProduct(@PathVariable(value="id") UUID id) {
        Optional<ProductModel> productO = productsServices.findById(id);
        // if condition on one line of code
    ...
    public ResponseEntity<Object> deleteProduct(@PathVariable(value = "id") UUID id) {
        Optional<ProductModel> productO = productsServices.findById(id);
        if(productO.isEmpty()) return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Product not found");
        productsServices.delete(productO.get());
        return ResponseEntity.status(HttpStatus.OK).body("Success. Product deleted.");
    }
